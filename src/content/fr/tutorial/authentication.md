...
> 
> For this to work you must be on version `0.7.0` or greater of Redwood. If you don't see any file changes, try [upgrading](/reference/command-line-interface#upgrade) your Redwood packages with `yarn rw upgrade`.
